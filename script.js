...
function alternarModoEscuro() {
    ...
    menuBar.style.backgroundColor = corpo.classList.contains('modo-escuro') ? 'rgb(104, 104, 104)' : '#fff';
    modoToggle.style.backgroundColor = corpo.classList.contains('modo-escuro') ? '#555' : '#ddd';
